...
class PersonViewController: UIViewController {
    let buttonToTheNextScreen = UIButton()
     ...
     @objc private func didTapNextScreenButton() {
         self.navigationController?.pushViewController(FirstPersonViewController(), animated: true)
     }
 }

 class FirstPersonViewController: UIViewController {
     ...
     @objc private func didTapNextScreenButton1() {
         self.navigationController?.pushViewController(SecondPersonViewController(), animated: true)
     }
 }

 class SecondPersonViewController: UIViewController {
